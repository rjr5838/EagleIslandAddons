using EagleIslandStudio.Controls;
using EagleIslandStudio.Entities;
...
namespace EagleIslandStudio {
	public partial class Studio : Form {
		...
		public void EnableStudio(bool hooked) {
			if (hooked) {
				string fileName = Path.Combine(Path.GetDirectoryName(memory.Program.MainModule.FileName), "EagleIsland.tas");
