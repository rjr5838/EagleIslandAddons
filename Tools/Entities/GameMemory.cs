...
namespace EagleIslandStudio.Entities {
	...
	public class GameMemory {
		...
		private static ProgramPointer EagleIsland = new ProgramPointer(AutoDeref.Single,
		...
		public string LevelName() {
			//EagleIsland.Instance.AutosplitterInfo.Level
			if (EagleIsland.Version == PointerVersion.XNA) {
				return EagleIsland.Read(Program, 0x0, 0xac, 0x14, 0x0);
			}
			return EagleIsland.Read(Program, 0x0, 0x8c, 0x14, 0x0);
		}
