namespace EagleIslandStudio {
	partial class Studio {
		...
		private void InitializeComponent() {
			...
			this.tasText = new EagleIslandStudio.Controls.RichText();
			...
			this.tasText.Language = EagleIslandStudio.Controls.Language.TAS;
			...
			this.tasText.TextChanged += new System.EventHandler<EagleIslandStudio.Controls.TextChangedEventArgs>(this.tasText_TextChanged);
			...
			this.tasText.LineInserted += new System.EventHandler<EagleIslandStudio.Controls.LineInsertedEventArgs>(this.tasText_LineInserted);
			this.tasText.LineNeeded += new System.EventHandler<EagleIslandStudio.Controls.LineNeededEventArgs>(this.tasText_LineNeeded);
			this.tasText.LineRemoved += new System.EventHandler<EagleIslandStudio.Controls.LineRemovedEventArgs>(this.tasText_LineRemoved);
			// 
			// Studio
			// 
